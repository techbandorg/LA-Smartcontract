    ...
    Ownable
{
    ...
    function transferFrom(
        ...
        require(
            getUserFromBlacklist(to) != to,
            "User (to) is in the Black List"
        );
    ...
    function _transfer(
        ...
        require(MGK.ownerOf(tokenId) == from, "transfer from incorrect owner");
...
// abstract contract AdditionalContract1 is MGK {
